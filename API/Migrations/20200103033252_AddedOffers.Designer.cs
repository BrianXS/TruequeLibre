...
namespace API.Migrations
{
    ...
    [Migration("20200103033252_AddedOffers")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("API.Entities.Offer", b =>
                {
                    ...
                    b.HasKey("OfferedProductId", "ReceiverProductId");
            ...
            modelBuilder.Entity("API.Entities.Offer", b =>
                {
                    b.HasOne("API.Entities.Product", "OfferedProduct")
                        .WithMany("OutcomingOffers")
                        .HasForeignKey("OfferedProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("API.Entities.Product", "ReceiverProduct")
                        .WithMany("IncomingOffers")
